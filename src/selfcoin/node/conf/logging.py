...
level=DEBUG
formatter=simpleFormatter
args=('node/data/log/debug.log', 'h')
# args=('node/data/log/debug.log', when='h', interval=1, backupCount=0, encoding=None, delay=False, utc=False)

[handler_errorTimedRotateFileHandler]
class=handlers.TimedRotatingFileHandler
level=WARN
formatter=simpleFormatter
args=('node/data/log/error.log', 'h')
...
level=DEBUG
formatter=simpleFormatter
args=('node/data/log/debug.log', 'w', 2000000, 2)
# args=('node/data/log/debug.log', mode='w', maxBytes=2000000, backupCount=2, encoding=None, delay=0)

[handler_errorRotateFileHandler]
class=handlers.RotatingFileHandler
level=WARN
formatter=simpleFormatter
args=('node/data/log/error.log', 'w', 2000000, 2)
...
level=DEBUG
formatter=simpleFormatter
args=('node/data/log/debug.log', 'a', 2*1024*1024, 2)
