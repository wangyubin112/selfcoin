...
def multiply(Xp, Yp, n, N, A, P):
    ...
    """
    return fromJacobian(*(jacobianMultiply(*(toJacobian(Xp, Yp)), n, N, A, P)), P)


def add(a_Xp, a_Yp, b_Xp, b_Yp, A, P):
    """
    Fast way to add two points in elliptic curves

    :param a(Xp, Yp): First Point you want to add
    :param b: Second Point you want to add
    :param P: Prime number in the module of the equation Y^2 = X^3 + A*X + B (mod p)
    :param A: Coefficient of the first-order term of the equation Y^2 = X^3 + A*X + B (mod p)
    :return: Point that represents the sum of First and Second Point
    """
    return fromJacobian(*(jacobianAdd(*(toJacobian(a_Xp, a_Yp)), *(toJacobian(b_Xp, b_Yp)), A, P)), P)
